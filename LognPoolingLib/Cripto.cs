...
namespace LognPoolingLib
{
    public class RsaWithCspKey
    {
        ...
        public string EncryptData(string dataToEncrypt)
        {
            ...
            {
                cipherbytes = rsa.Encrypt(Encoding.Default.GetBytes(dataToEncrypt), false);
            }
        ...
        public string DecryptData(string dataToDecrypt)
        {
            ...
            using (var rsa = new RSACryptoServiceProvider(2048, cspParams))
            {
                plain = rsa.Decrypt(Convert.FromBase64String(dataToDecrypt), false);
            }
            return Encoding.Default.GetString(plain);
        }
    }
